# Data Model - Top3 Case v0.7 (Ontology-Aligned) - agent-top3pm
...
- `Top3Case ownedBy Person(PM)` <- workflow governance role; current value sourced from Mantis `Assigned PM` as workaround. `HPO-CONFIRMED WORKAROUND`
