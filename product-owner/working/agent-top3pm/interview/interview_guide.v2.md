...
10. What is copied as-is vs transformed summary?
11. What errors/ambiguities happen most often at this step?

### 3. Candidate Problem Validation and Ranking
What I tell the interviewee:
- I will present prepared candidate problems; you validate with evidence.

What I get:
- Confirmed problem set ranked by frequency × severity × business impact.

Questions:
12. Which candidate problems are real in your daily operation?
13. Which problem should be split/merged/reworded?
14. Give one recent concrete case for each confirmed problem.
15. Rank each by frequency, severity, business impact.

### 4. Goal and Metric Validation
What I discuss:
- Map problems -> goals -> measurable metrics.
