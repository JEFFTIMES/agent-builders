...
1. Walk through one full TOP3 case from assignment to closure: trigger, actor, tool, output, decision at each step.
2. What exact role boundary exists between PM, Dev, QA, TAM/CSE, and sales/customer-facing roles?
3. In your two-tier team model, what information is Core-only vs All-shared?

### Section B - System Usage and Data Movement
4. For each system (Mantis, Teams, Jenkins, Outlook, InfoSite, Phabricator), what data is read, written, and copied manually?
5. What identifiers link records across systems (ticket ID, branch name, build ID, task ID, image tag)?
6. Where does data duplication happen most often, and what is copied verbatim versus summarized?

### Section C - Pain Points and Impact
7. For the top pain points, provide frequency, severity, and business impact with one concrete recent example.
8. Which delays are most common: investigation, reproduction, build, QA, release, or communication alignment?
9. What failures create the largest customer or business risk?

### Section D - Knowledge Capture and Reuse
10. Which knowledge objects should be captured from each case (symptoms, repro steps, root cause, workaround, fix mapping, release notes)?
11. What format makes captured knowledge reusable in future cases?
12. What quality bar determines whether captured knowledge is trustworthy for reuse?

### Section E - AI-Agent Participation (Step 2 detail)
13. Which actions can the AI agent do autonomously in each phase?
14. Which actions require approval, and who approves them?
15. What escalation conditions should force human takeover?

### Section F - Metrics and Constraints
16. What baseline and target should we set for north-star and each guardrail metric?
17. What security/access/compliance constraints limit agent access per system?
18. What data must remain out of scope for agent ingestion or generation?
