...
| Role        | Primary Needs                                                                             |
| ----------- | ----------------------------------------------------------------------------------------- |
| Role A      | Track case progress, conduct routine actions, write notes and summary                     |
| Role B      | Accumulate domain knowledge, update templates                                             |



## As-Is workflow

*How does the user conduct a series of tasks, including inter-human interactions, human-system interactions, to accomplish what business purpose?* 
